...
const JUGADORS = [
  {
    nom: "Jordi",
    color: "#e74c3c",
    img: "img/avatars/Jordi.jpeg",
    cara: "img/avatars/Jordi_cara.png",
    vid: "img/personatges/jordi_ruleta.mp4",
  },
  {
    nom: "Anna",
    color: "#e84393",
    img: "img/avatars/Anna.jpeg",
    cara: "img/avatars/Anna_cara.png",
    vid: "img/personatges/anna_ruleta.mp4",
  },
  {
    nom: "Laia",
    color: "#27ae60",
    img: "img/avatars/Laia.jpeg",
    cara: "img/avatars/Laia_cara.png",
    vid: "img/personatges/laia_ruleta.mp4",
  },
  {
    nom: "Mons",
    color: "#8e44ad",
    img: "img/avatars/Mons.jpeg",
    cara: "img/avatars/Mons_cara.png",
    vid: "img/personatges/mons_ruleta.mp4",
  },
  {
    nom: "Xu",
    color: "#2980b9",
    img: "img/avatars/Xu.jpeg",
    cara: "img/avatars/Xu_cara.png",
    vid: "img/personatges/xu_ruleta.mp4",
  },
  {
    nom: "Joa",
    color: "#f1c40f",
    img: "img/avatars/Joa.jpeg",
    cara: "img/avatars/Joa_cara.png",
    vid: "img/personatges/joa_ruleta.mp4",
  },
];
...
function dibuixaRuleta(angleOffset = 0) {
  ...
  participants.forEach((j, i) => {
    ...
    grd.addColorStop(1, baseColor + "99");
    ...
    if (im && im.complete && im.naturalWidth > 0) {
      ...
      const cropH = im.naturalHeight * 0.7;
...
function mostrarResultat(angle, participants, arc) {
  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      document.getElementById("resultat-emoji").innerHTML =
        `<div style="width:80px;height:80px;border-radius:50%;overflow:hidden;border:3px solid ${guanyador.color};background:#0a1628;margin:0 auto"><video src="${guanyador.vid}" autoplay muted playsinline loop style="width:100%;height:100%;object-fit:cover;object-position:top"></video></div>`;
...
function afegirHistorial(jugador, pregunta) {
  ...
  const dia =
    ...
    "/" +
    (ara.getMonth() + 1).toString().padStart(2, "0");
  const hora =
    ara.getHours().toString().padStart(2, "0") +
    ":" +
    ara.getMinutes().toString().padStart(2, "0");
