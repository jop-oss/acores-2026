...
const REPTES_INICIALS = [
  ...
  "Fes una tombarella",
  "Aprèn a dir 5 paraules en portuguès (que no siguin hola, adéu, gràcies, bon dia, ...)",
  ...
  "Fes una ruta de senderisme cantant una cançó per cada hora que duri",
  "Prova el vi blanc de Pico",
  "Compra alguna cosa en un mercat local o botiga de souvenirs",
  "Fes una foto amb algú que no coneixes",
  "Banya't a 3 platges o piscines naturals diferents en un sol dia",
  "Enfila't a un arbre",
  "Neda fins a un illot o roca al mar",
  "Corre sense parar durant com a mínim 2km a Sao Miguel, 1,5km a Pico, 1km a Faial i 0,5 km a Sao Jorge",
  "Parla amb algú cantant durant 5 minuts",
  "No diguis ni \"sí\" ni \"no\" durant tota una excursió",
  "Fes escalada o alguna acció semi-perillosa (però controlada) que faci que la Mons et renyi",
];
